...
<head>
  ...
  <!-- Favicons -->
  <link href="../../../parame/assets/img/favicon.png" rel="icon">
  <link href="../../../parame/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="../../../parame/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="../../../parame/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="../../../parame/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="../../../parame/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
  <link href="../../../parame/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="../../../parame/assets/css/main.css" rel="stylesheet">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <!-- <img src="../../../parame/assets/img/logo.webp" alt=""> -->
        <h1 class="sitename">FASHION SHOPE</h1>
      </a>
  ...
  <main class="main">
          ...
          <div class="col-lg-5" data-aos="zoom-out">
            <div class="visual-content">
              <div class="fluid-shape">
                <img src="../../../parame/assets/img/abstract/Capture.PNG" alt="Abstract Fluid Shape" class="fluid-img">
              </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>About</h2>
        <div><span>LEARN</span> <span class="description-title">ABOUT OUR EMPLOYES</span></div>
        ...
        <div class="row gx-5 align-items-center">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="about-image position-relative">
              <img src="../../../parame/assets/img/about/about-portrait-1.webp" class="img-fluid rounded-4 shadow-sm" alt="About Image"
                loading="lazy">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-left" data-aos-delay="300">
            <div class="about-content">
              <h2> THIS IS OUR PET DOG</h2>
              <p class="lead">THIS IS OUR GUARD DOG, HES NAME IS JERSON THE GAY</p>
              <p>Jerson, you're more than just a dog – you're a heart-warmer, a tail-wagger, and a best friend all
                rolled into one. Your loyalty and joy are contagious, and the world is a better place with you in it.
                Whether you're cuddling up or running around, you bring a sense of peace and happiness that’s truly
                unmatched. Keep being awesome, Jerson!"

                How does that sound for your furry friend?
              </p>
              ...
              <div class="row g-4 mt-3">
                <div class="col-md-6" data-aos="zoom-in" data-aos-delay="400">
                  <div class="feature-item">
                    ...
                    <h5>talent</h5>
                    <p>he can svck dick of another dogs</p>
                  </div>
                </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
          ...
          <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
            <img src="../../../parame/assets/img/misc/misc-1.webp" alt="Digital Platform" class="img-fluid rounded-4">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    <h2>Gerald, Rosales T.</h2>
                    <p>One Finger Man || Mukanburat</p>
                    <p>No Comments</p>
                    <div class="profile d-flex align-items-center">
                      <img src="../../../parame/assets/img/person/Gerald.JPG" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Gerlad, Rosales T.</h3>
                        <span>Client</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../../../parame/assets/img/person/Gerald.JPG" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    <h2>Joshit Macbill Baccaro</h2>
                    <p>I am a person who is always in a state of pain.</p>
                    <p>Vroom Vroom...</p>
                    <div class="profile d-flex align-items-center">
                      <img src="../../../parame/assets/img/person/JM.JPG" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Sara Wilsson</h3>
                        <span>Designer</span>
                      </div>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../../../parame/assets/img/person/JM.JPG" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="../../../parame/assets/img/person/Revena.jpg" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>REVENA</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../../../parame/assets/img/person/Revena.jpg" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-1.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">UI/UX Design</div>
                      <h3 class="entry-title">Mobile Banking App</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-1.webp" class="glightbox"
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-10.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Development</div>
                      <h3 class="entry-title">E-Learning Platform</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-10.webp" class="glightbox"
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-photography">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-7.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Photography</div>
                      <h3 class="entry-title">Urban Architecture</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-7.webp" class="glightbox"
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-marketing">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-4.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Marketing</div>
                      <h3 class="entry-title">Social Media Campaign</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-4.webp" class="glightbox"
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-2.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">UI/UX Design</div>
                      <h3 class="entry-title">Smart Dashboard Interface</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-2.webp" class="glightbox"
                          data-gallery="portfolio-gallery-ui"
                          data-glightbox="title: Smart Dashboard Interface; description: At vero eos et accusamus et iusto odio dignissimos ducimus.">
                          <i class="bi bi-arrows-angle-expand"></i>
                        </a>
                        <a href="portfolio-details.html">
                          <i class="bi bi-arrow-right"></i>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-11.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Development</div>
                      <h3 class="entry-title">Cloud Management System</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-11.webp" class="glightbox"
                          data-gallery="portfolio-gallery-development"
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-photography">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-8.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Photography</div>
                      <h3 class="entry-title">Nature Collection</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-8.webp" class="glightbox"
                          data-gallery="portfolio-gallery-photography"
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-marketing">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="../../../parame/assets/img/portfolio/portfolio-5.webp" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Marketing</div>
                      <h3 class="entry-title">Brand Strategy</h3>
                      <div class="entry-links">
                        <a href="../../../parame/assets/img/portfolio/portfolio-5.webp" class="glightbox"
                          data-gallery="portfolio-gallery-marketing"
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="../../../parame/assets/img/person/person-m-7.webp" class="img-fluid" alt="" loading="lazy">
              </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="../../../parame/assets/img/person/Jerson.JPG" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Jerson Tolentino</h4>
                <span>Product Manager & Guard Dog</span>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="../../../parame/assets/img/person/Axel.JPG" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Axle Lapiz G.</h4>
                <span>CTO</span>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="../../../parame/assets/img/person/Reben.jpg" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Reben G.</h4>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="contact-info-box">
              ...
              <div class="info-content">
                <h4>Our Address</h4>
                <p>Pangdan, City Of Naga Cebu<p></p>
              </div>
            </div>
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="../../../parame/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="../../../parame/assets/vendor/php-email-form/validate.js"></script>
  <script src="../../../parame/assets/vendor/aos/aos.js"></script>
  <script src="../../../parame/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="../../../parame/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="../../../parame/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
  <script src="../../../parame/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>

  <!-- Main JS File -->
  <script src="../../../parame/assets/js/main.js"></script>
